				...
				<div class="resp-tabs-container">
						...
						<div class="col-md-3 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{{asset('/storage/'.$lp->image_path)}}" alt="" class="pro-image-front">
									<img src="{{asset('site/images/w2.png')}}" alt="" class="pro-image-back">
								...
								<div class="item-info-product ">
									<h4><a href="single.html">{{$lp->name}}</a></h4>
									<div class="info-product-price">

										@if($lp->discounted_price)
											<span class="item_price">${{$lp->price-$lp->discounted_price}}</span>
											<del>${{$lp->price}}</del>
										@else 
										<span class="item_price">${{$lp->price}}</span>
										@endif
						...
						<div class="col-md-3 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									...
									<a href="{{ url("/cart/add/$lp->id",[]) }}" class="item_add single-item hvr-outline-out button2">Add to cart</a>									
								</div>
							</div>
						</div>
					...
					<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-2">
						<div class="col-md-3 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{{asset('site/images/g1.png')}}" alt="" class="pro-image-front">
									<img src="{{asset('site/images/g1.png')}}" alt="" class="pro-image-back">
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<a href="single.html" class="link-product-add-cart">Quick View</a>
											</div>
